...
<Card.Root class="gap-0 p-0">
	<Card.Content class="relative lg:flex p-0 divide-y lg:divide-x lg:divide-y-0">
    <div class="flex lg:max-w-[320px] lg:min-w-[280px] flex-col gap-6 p-6">
      <MeetingInfo />
    </div>
    <div class="grid divide-y md:divide-y-0 md:grid-cols-2 lg:flex md:divide-x">
      <div class="p-6">
        <Calendar
          weekStartsOn={1}
          type="single"
          ...
          class="
            bg-transparent p-0 [--cell-size:--spacing(10)] max-w-88 mx-auto
